Автор Афанасьева К.А ПИ-31
## Лабораторная работа №1 «ИС Управление розничным магазином»
### Цель. 
      Выявить функциональные требования с помощью бизнес процессов. Понять, как взаимосвязаны бизнес процессы с информационными системами для Управления розничным магазином, зачем нужны функциональные требования, а так же ознакомиться с моделями информационных систем, и внешними объектами интеграций с информационными системами. Найти основные бизнес процессы
...
## 5. Спецификация раскрывает детали, которые диаграмма показывает слишком обобщённо.
   В ней обычно фиксируют:
